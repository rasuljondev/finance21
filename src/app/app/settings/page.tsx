...
import { getUSDToUZSRate, formatCurrency } from "@/lib/currency";
...
export default function SettingsPage() {
  ...
  const [exchangeRate, setExchangeRate] = useState<number>(12845.0);
    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-500/10 dark:to-indigo-500/10 rounded-xl px-4 py-2 border border-blue-200 dark:border-blue-500/20">
            <div className="flex items-center gap-2">
              <DollarSign className="w-4 h-4 text-blue-600 dark:text-blue-400" />
              <span className="text-xs font-bold text-blue-900 dark:text-blue-100">
                1 USD = {formatCurrency(exchangeRate)} UZS
              </span>
              <button
                onClick={fetchExchangeRate}
                className="ml-1 p-1 hover:bg-blue-100 dark:hover:bg-blue-500/20 rounded transition-colors"
